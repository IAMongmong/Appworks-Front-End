...
function ApplicationTime() {
  ...
  return (
    <div className="col-span-12 xl:col-span-8 bg-white dark:bg-gray-200 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      ...
      <div className="grow">
        ...
        {labels && <LineChart data={chartData} width={389} height={600} />}
      </div>
    </div>
  );
}
